            ...
            <div class="right_col" role="main">
                ...
                <div class="card text-center card-shrink">
                    <div class="card-header">
                        <h4>Add Technical Officers</h4>
                    </div>
                    <div class="card-body">

								<form action="${pageContext.request.contextPath}/add-to" method="post">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-sm" placeholder="Mobile" name="mobile" id="mobile" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="row">
                                        <button type="submit" class="btn btn-primary btn-block" style="width: 150px; margin: 0 auto;">Register</button>
                                    </div>
                                </form>
